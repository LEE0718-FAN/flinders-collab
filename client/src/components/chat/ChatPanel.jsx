...
export default function ChatPanel({ roomId }) {
  ...
  if (loading) {
    return (
      <div className="flex h-[600px] items-center justify-center rounded-2xl border border-slate-200/60 bg-white shadow-xl shadow-blue-500/5">
  ...
  return (
    <div className="flex h-[600px] flex-col rounded-2xl border border-slate-200/60 bg-white shadow-xl shadow-blue-500/5 overflow-hidden">
      {/* Gradient header */}
